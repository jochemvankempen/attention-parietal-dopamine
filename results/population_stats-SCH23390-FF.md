...
```
    ...
    ##    232.0    244.2   -110.0    220.0       50 
    ## 
    ## Scaled residuals: 
    ##     Min      1Q  Median      3Q     Max 
    ## -1.5750 -0.4507 -0.0151  0.2449  4.9173 
    ## 
    ## Random effects:
    ##  Groups   Name        Variance Std.Dev.
    ##  unit     (Intercept) 1.666    1.291   
    ##  Residual             2.080    1.442   
    ## Number of obs: 56, groups:  unit, 14
    ## 
    ## Fixed effects:
    ##                     Estimate Std. Error      df t value Pr(>|t|)    
    ## (Intercept)           3.8125     0.3951 14.0000   9.649 1.45e-07 ***
    ## attention1            0.3042     0.1927 42.0000   1.579    0.122    
    ## drug_on1              0.2818     0.1927 42.0000   1.462    0.151    
    ## attention1:drug_on1   0.2186     0.1927 42.0000   1.134    0.263    
    ## ---
...
```
    ...
    ## 4 model.att_drug     6  232.  244.  -110.     220.      1.27     1   0.260
...
```
    ...
    ## 
    ## 21 message(s): boundary (singular) fit: see help('isSingular')

|                      |      2.5 % |    97.5 % |
|:---------------------|-----------:|----------:|
| .sig01               |  0.5348598 | 1.8416809 |
| .sigma               |  1.0838569 | 1.6914162 |
| (Intercept)          |  3.0433024 | 4.5868164 |
| attention1           | -0.0677049 | 0.6822821 |
| drug\_on1            | -0.0852451 | 0.6769466 |
| attention1:drug\_on1 | -0.1521265 | 0.6020039 |
...
```
    ...
    ## 2 bootstrap.drug     0.103 0.106
    ## 3 bootstrap.att_drug 0.178 0.205
...
```
    ...
    ## [1] 0.4015809 0.4329399 0.4598252 0.4759969
